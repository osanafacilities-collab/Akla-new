...
export const CommodityTicker: React.FC = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#0F3158] via-[#144275] to-[#0F3158] border-y border-[#C89B3C]/40 relative overflow-hidden py-3 text-xs select-none shadow-[0_4px_20px_rgba(19,62,114,0.25)] z-30">
      {/* Ambient gold glow on left and right fade edges */}
      <div className="absolute top-0 bottom-0 left-0 w-24 sm:w-36 bg-gradient-to-r from-[#0F3158] to-transparent z-10 pointer-events-none" />
      <div className="absolute top-0 bottom-0 right-0 w-24 sm:w-36 bg-gradient-to-l from-[#0F3158] to-transparent z-10 pointer-events-none" />

      {/* Floating static badge on the far left */}
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 flex items-center gap-4">
        <div className="shrink-0 flex items-center gap-2 bg-[#164980] border border-[#C89B3C]/60 px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-wider text-[#FDE68A] shadow-xs z-20">
