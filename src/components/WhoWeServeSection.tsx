...
export const WhoWeServeSection: React.FC = () => {
  ...
  return (
    <section id="industries" className="scroll-mt-24 py-24 lg:py-32 bg-[#F1F5F9] border-b border-[#E2E8F0] text-[#0F172A] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {industries.map((ind, idx) => (
            <motion.div
              ...
              className="bg-white p-7 text-center rounded-2xl border border-[#E2E8F0] shadow-[0_4px_20px_rgba(27,86,153,0.06)] transition-all duration-300 hover:border-[#C89B3C] hover:shadow-[0_18px_40px_rgba(200,155,60,0.16)] group flex flex-col justify-between cursor-default luxury-sheen"
            >
              <div>
                ...
                <h3 className="text-[19px] font-heading font-bold text-[#1B5699] mb-2 group-hover:text-[#C89B3C] transition-colors">
                  {ind.name}
                </h3>
              ...
              <div className="pt-4 mt-4 border-t border-[#F1F5F9]">
                <span className="inline-block text-[11px] font-bold text-[#1B5699] bg-[#F8FAFC] group-hover:bg-[#FFF8EB] group-hover:text-[#B8860B] px-3 py-1 rounded-full border border-[#E2E8F0] transition-colors">
                  {ind.badge}
                </span>
              </div>
            </motion.div>
